...
namespace monaco_chess.src
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Player juan = new Player("Marcos Lomo", "Juan", club, 0, Country.ESP, new DateTime(1999, 3, 27), 1600, 1300);
            Player omar = new Player("García González", "Omar", club, 0, Country.ESP, new DateTime(1999, 3, 27), 1600, 1300);
